    ...
    public class FoodDataSource
    {
        ...
        public void load()
        {
            ...
            lstFood = new List<Food>()
            {
                ...
                new Food() { Name = "살사리코버거", Price = 1000, Count = 1, ImagePath = "Image/b4.png", Category = eCategory.Burger},
                new Food() { Name = "치즈베이컨버거", Price = 1000, Count = 1, ImagePath = "Image/b5.jpg", Category = eCategory.Burger},
                ...
                new Food() { Name = "라이스&치킨너겟", Price = 1000, Count = 1, ImagePath = "Image/s4.jpg", Category = eCategory.Side},
                new Food() { Name = "어니언치즈감자", Price = 1000, Count = 1, ImagePath = "Image/s5.jpg", Category = eCategory.Side},
                ...
                new Food() { Name = "레몬딸기스무디", Price = 1000, Count = 1, ImagePath = "Image/d4.jpg", Category = eCategory.Drink},
                new Food() { Name = "레몬에이드", Price = 1000, Count = 1, ImagePath = "Image/d5.jpg", Category = eCategory.Drink},
            };
